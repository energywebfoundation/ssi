...
export class CredentialsService implements CredentialVerifier {
  ...
  /**
   * Assembles presentation according to definition from provided credentials
   */
  presentationFrom(
    ...
    const { verifiableCredential, areRequiredCredentialsPresent, matches } = pex.selectFrom(
    ...
    console.dir({ verifiableCredential, matches }, { depth: 20, colors: true });
