 ...
 */
@Injectable()
export class DecentralizedWebNodeInterceptor implements NestInterceptor<ResponseObjectDto> {
  ...
  intercept(context: ExecutionContext, next: CallHandler): Observable<ResponseObjectDto> {
