...
export class MessageService {
  ...
  async save(message: CollectionsWriteMessage): Promise<CollectionsWriteMessage | undefined> {
    ...
    if (foundMessage && message.dateCreated > foundMessage.dateCreated) {
      ...
      item = message.cid > foundMessage.cid ? await this.messageRepository.save(message) : foundMessage;
    } else {
      item = await this.messageRepository.save(message);
    }
    return item;
