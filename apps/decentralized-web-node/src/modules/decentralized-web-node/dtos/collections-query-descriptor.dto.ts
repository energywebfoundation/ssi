...
import { IsDefined, IsEnum, IsMimeType, IsOptional, IsString, IsUrl, IsUUID } from 'class-validator';
...
export class CollectionsQueryDescriptorDto {
  ...
  @IsOptional()
  @IsString()
  @IsEnum(['createdAscending', 'createdDescending', 'publishedAscending', 'publishedDescending'])
  dateSort?: DataSort;
