...
- Could "QueryByFrame" be used to ask for contract VC? https://pr-preview.s3.amazonaws.com/w3c-ccg/vp-request-spec/pull/12.html#query-by-frame
  - Could be powerful as perhaps could ask for a specific signature type with specifc DID
  - First, ask for DID auth to get DID. Then ask for a contract signed by the DID in question
